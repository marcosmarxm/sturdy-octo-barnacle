...
select
    ...
    {{ json_extract_scalar('_airbyte_data', ['companyId']) }} as companyid,
    ...
    {{ json_extract_array('_airbyte_data', ['mergeAudits']) }} as mergeaudits,
    {{ json_extract_array('_airbyte_data', ['stateChanges']) }} as statechanges,
    {{ json_extract_array('_airbyte_data', ['additionalDomains']) }} as additionaldomains,
    _airbyte_emitted_at
from {{ source('public', '_airbyte_raw_hubspot_companies') }}
-- hubspot_companies
